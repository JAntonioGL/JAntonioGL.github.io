...
<div class="card-grid" style="margin-top: 2rem; max-width: 450px; margin-left: auto; margin-right: auto;">
<div class="card">
...
<strong>Aviso de seguridad:</strong> No ofrecemos archivos <code>.apk</code> ni betas públicas en otros sitios. <br>La Google Play Store es nuestro único canal oficial de descarga.
</p>
</div>
</div>